...
import com.eastcom.mycitycard.adapters.fundFragmentAdapter;
...
public class FundsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fundFragmentAdapter fundsAdapter = new fundFragmentAdapter(getActivity().getSupportFragmentManager());
        fundsAdapter.addFragment(new FundTabFragment(1), "Fund 1");
        fundsAdapter.addFragment(new FundTabFragment(2), "Fund 2");
        viewPager.setAdapter(fundsAdapter);
